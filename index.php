    ...
    <div class="card text-dark">
        <div class="container" style="padding-bottom: 20px;">
            <div class="row justify-content-center">
                ...
                <h2 class="mb-10">Certificados</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="single-service card">
                        <a href="http://www.rbprev.riobranco.ac.gov.br/documentos/rpps_pro_gestao.pdf">
                            <div class="thumb">
                                <img src="images/certificados/c_progestao.png"  alt="Certificado pro gestão" title="Certificado pro gestão">                  
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6">
                    <div class="single-service card">
                        <a href="http://rbprev.riobranco.ac.gov.br/noticias/2021/index.php/2021/08/23/rbprev-recebe-selo-do-programa-nacional-de-prevencao-a-corrupcao-pnpc/">
                            <div class="thumb">
                                <img alt="Contracheque" src="images/certificados/c_prevencao.png" title="Prevenção a corrupção">                  
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6">
                    <div class="single-service card">
                        <a href="http://www.rbprev.riobranco.ac.gov.br/documentos/CertificadoGreenCarbon.pdf">
                            <div class="thumb">
                                <img alt="Simular Aposentadoria" src="images/certificados/c_greenCarbon.png" title="Certificado Green Carbon">                 
                            </div>
                        </a>
                    </div>
                </div>
