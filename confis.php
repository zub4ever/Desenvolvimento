 ...
 <div class="jumbotron d-flex justify-content-center bg-light">
    <div class="text-black">
        <div class="ml-auto mt-auto mr-auto mb-auto">
            ...
            <h2 class="text-left font-weight-bold text-uppercase py-1 text-white">Conselho Fiscal - CONFIS</h2>
        </div>
    </div>
</div>
<div class="container pb-3 mb-3 ">
	<div class="row mt-5 mb-5 py-5 d-flex justify-content-space-between">
		...
		<div class="col-sm-12 col-lg-3 mt-3">
			<a href="atasdasreunioesconfis.php" class="btn btn-primary" style="width: 100%;">
