...
<div class="jumbotron d-flex justify-content-center bg-light">
    <div class="text-black">
        <div class="ml-auto mt-auto mr-auto mb-auto">
            ...
            <h2 class="text-left font-weight-bold text-uppercase py-1 text-white">Informações sobre Certidão de Tempo de Contribuição</h2>
        </div>
    </div>
</div>
<div class="container">
  ...
  <i class="fa fa-check"></i>&nbsp; Abaixo estão os documentos necessárias para emissão da CTC:

  <ul align="justify">
    <li>Requerimento do Servidor;</li>
    <li>Comprovante de endereço atualizado;</li>
    <li>Comprovação do ingresso no serviço público municipal (CTPS, Contrato de Trabalho, D.O.E de nomeação);</li>
    <li>Comprovação, quando for o caso, do desligamento do serviço público municipal (CTPS, Rescisão do Contrato de Trabalho, DOE de exoneração);</li>
    <li>Cópia legível do RG, CPF e PIS/PASEP/NIT;</li>
    <li>Certidão de casamento, em se tratando de requerente do sexo feminino e quando do ato de ingresso no serviço público constar o nome de solteira</li>
    <li>Ficha funcional;</li>
    <li>Certidão de Tempo de Serviço, fornecida pelo órgão de origem (RH);</li>
    <li>Fichas financeiras do período de 1º de abril de 2010 até a data da exoneração.</li>

</ul>

<b><a href="documentos/portaria_n_154.pdf" target="_blank">Link da Portaria MPS nº 154.</a><br/></b>
<b><a href="documentos/requerimento_emissao_ctc.pdf" target="_blank">Link do Requerimento.</a></b>
</div>
<br>
