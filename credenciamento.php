...
<div class="jumbotron d-flex justify-content-center bg-light">
    <div class="text-black">
        <div class="ml-auto mt-auto mr-auto mb-auto">
            ...
            <h2 class="text-left font-weight-bold text-uppercase py-1 text-white">Credenciamento</h2>
        </div>
    </div>
</div>
  ...
  <div class="row mt-5 mb-5 py-5 d-flex justify-content-space-between">
    <div class="col-sm-12 col-lg-4 mt-3">
      <a href="#" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Edital</h6>
      </a>
    </div>
    <div class="col-sm-12 col-lg-4 mt-3">
      <a href="#" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Anexos/Formulários</h6>
      </a>
    </div>
     <div class="col-sm-12 col-lg-4 mt-3">
      <a href="#" class="btn btn-primary" style="width: 100%;">
        <h6 class="text-left font-weight-bold text-uppercase text-white">Credenciados</h6>
      </a>
    </div>
  </div>
